...
#ifndef INCLUDE_STONKY_BYBIT_SPOT_EXCHANGE_CONNECTOR_H
#define INCLUDE_STONKY_BYBIT_SPOT_EXCHANGE_CONNECTOR_H
...
#endif //INCLUDE_STONKY_BYBIT_SPOT_EXCHANGE_CONNECTOR_H
